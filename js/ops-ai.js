...
(function() {
  ...
  function generateProposalPDF(proposalText, lead) {
    ...
    doc.text(lang === 'es' ? 'Infraestructura de IA para empresas en Puerto Rico' : 'AI Infrastructure for Puerto Rico Businesses', margin, y);
