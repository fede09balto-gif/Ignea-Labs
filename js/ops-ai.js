...
(function() {
  ...
  function generateProposalPDF(proposalText, lead) {
    ...
    doc.text('ignealabs@outlook.com', margin, y + 4);
    ...
    doc.text('ignea.labs — ignealabs@outlook.com — ignealabs.com', margin, y);
