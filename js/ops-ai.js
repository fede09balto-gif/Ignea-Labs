...
(function() {
  ...
  function generateProposalPDF(proposalText, lead) {
    ...
    doc.text(lang === 'es' ? 'Infraestructura de IA para empresas centroamericanas' : 'AI Infrastructure for Central American Businesses', margin, y);
