...
var IgneaI18n = (function() {
  ...
  var translations = {
    es: {
      ...
      // ---- HOMEPAGE: MARQUEE ----
      "mq.r1.ind": "🍽 Restaurante · Bayamón",
      "mq.r1.res": "22 hrs/semana recuperadas",
      "mq.r2.ind": "🏥 Clínica · San Juan",
      "mq.r2.res": "60% menos no-shows",
      "mq.r3.ind": "⚖️ Firma Legal · Ponce",
      "mq.r3.res": "$1,840/mes recuperados",
      "mq.r4.ind": "🏨 Hotel · Condado",
      "mq.r4.res": "28% aumento en ocupación",
      "mq.r5.ind": "🛍 Retail · Caguas",
      "mq.r5.res": "Inventario 100% automatizado",
      "mq.r6.ind": "🏗 Construcción · Guaynabo",
      "mq.r6.res": "32 hrs/semana recuperadas",
      ...
      "ind.rest.roi": "Recupera 18–25 hrs/semana. ROI típico: 2.1 meses.",
      "ind.clinic.label": "Clínica",
      "ind.clinic.pain": "Citas por teléfono, recordatorios manuales, expedientes en papel.",
      "ind.clinic.solution": "Agendamiento automático 24/7 + recordatorios por WhatsApp + resumen de notas por IA.",
      "ind.clinic.roi": "Reduce no-shows 60%. ROI típico: 1.8 meses.",
      "ind.hotel.label": "Hotel",
      "ind.hotel.pain": "Reservas manuales, check-in en papel, comunicación desorganizada con huéspedes.",
      "ind.hotel.solution": "Motor de reservas integrado + mensajería automatizada a huéspedes + sincronización de canales.",
      "ind.hotel.roi": "Aumenta ocupación 15–30%. ROI típico: 2.4 meses.",
      "ind.law.label": "Firma Legal",
      "ind.law.pain": "Facturación manual, seguimiento de tiempo en Excel, intake de clientes por correo.",
      "ind.law.solution": "Intake automatizado de clientes + rastreo de horas con IA + facturación y recordatorios automáticos.",
      "ind.law.roi": "Captura 8–12 hrs/semana en facturación perdida. ROI: 1.5 meses.",
      ...
      // ---- DEMO REPORT ----
      "demo.banner": "Este es un reporte de muestra \u2014 basado en datos reales de un restaurante en Puerto Rico.",
    ...
    en: {
      ...
      // ---- HOMEPAGE: MARQUEE ----
      "mq.r1.ind": "🍽 Restaurant · Bayamón",
      "mq.r1.res": "22 hrs/week recovered",
      "mq.r2.ind": "🏥 Clinic · San Juan",
      "mq.r2.res": "60% fewer no-shows",
      "mq.r3.ind": "⚖️ Law Firm · Ponce",
      "mq.r3.res": "$1,840/month recovered",
      "mq.r4.ind": "🏨 Hotel · Condado",
      "mq.r4.res": "28% occupancy increase",
      "mq.r5.ind": "🛍 Retail · Caguas",
      "mq.r5.res": "100% automated inventory",
      "mq.r6.ind": "🏗 Construction · Guaynabo",
      "mq.r6.res": "32 hrs/week recovered",
      ...
      "ind.rest.roi": "Recover 18–25 hrs/week. Typical ROI: 2.1 months.",
      "ind.clinic.label": "Clinic",
      "ind.clinic.pain": "Phone-only appointments, manual reminders, paper records.",
      "ind.clinic.solution": "24/7 auto-scheduling + WhatsApp reminders + AI-powered note summaries.",
      "ind.clinic.roi": "Reduce no-shows 60%. Typical ROI: 1.8 months.",
      "ind.hotel.label": "Hotel",
      "ind.hotel.pain": "Manual bookings, paper check-in, disorganized guest communication.",
      "ind.hotel.solution": "Integrated booking engine + automated guest messaging + channel sync.",
      "ind.hotel.roi": "Increase occupancy 15–30%. Typical ROI: 2.4 months.",
      "ind.law.label": "Law Firm",
      "ind.law.pain": "Manual billing, Excel time tracking, email-only client intake.",
      "ind.law.solution": "Automated client intake + AI time tracking + auto-billing and reminders.",
      "ind.law.roi": "Capture 8–12 hrs/week in lost billing. ROI: 1.5 months.",
      ...
      // ---- DEMO REPORT ----
      "demo.banner": "This is a sample report \u2014 based on real data from a restaurant in Puerto Rico.",
