...
var IgneaI18n = (function() {
  ...
  var translations = {
    es: {
      ...
      "ind.ferre.label": "Ferretería",
      "ind.ferre.pain": "Precios en la cabeza del dueño, cotizaciones a mano, inventario en cuaderno.",
      "ind.ferre.solution": "Asistente de WhatsApp que consulta existencias y arma la proforma en el formato del negocio.",
      "ind.ferre.out": "Cotización y proforma quedan listas en la misma conversación",
      ...
      "ind.rest.out": "Pedidos y reservas quedan registrados sin pasar por el mostrador",
      ...
      "ind.clinic.out": "Cita agendada y recordatorio programado en la misma conversación",
      ...
      "ind.hotel.out": "Disponibilidad, reserva y enlace de pago en un solo hilo",
      ...
      "ind.law.out": "Cada caso con su plazo registrado y su alerta programada",
      ...
      "ind.mfg.out": "Cada lote queda trazado desde la orden hasta la entrega",
      ...
      "ind.agro.out": "El expediente de trazabilidad se arma solo, listo para auditoría",
      ...
      "ind.school.out": "Matrícula y comunicación con padres en un solo canal",
      ...
      "ind.construct.out": "Presupuestos armados desde catálogo, con precios al día",
      ...
      "pr.c1.desc": "Operamos en toda Latinoamérica. Entendemos las regulaciones locales, las cadenas de suministro y cómo se hacen negocios en cada mercado.",
      ...
      "intake.landing.sub": "5 preguntas cortas. Cero compromiso. Nos da lo que necesitamos para llegar a la llamada listos — sin hacerte perder tiempo repitiendo lo básico.",
      "intake.landing.s1": "5 preguntas cortas",
      ...
      "hero.cta.diagnostic": "Ver qué le costaría",
      "hero.cta.diagnostic.note": "5 preguntas",
      "ct.ch.diagnostic": "Ver qué le costaría",
      "intake.phone.hint": "¿Está completo el número? Por ejemplo: 8935-9013",
      "intake.field.revenue": "Ingresos mensuales aproximados (opcional)",
      "intake.rev.note": "Opcional. Nos ayuda a proponer algo del tamaño correcto. Si prefieres no decirlo, no hay problema — puedes dejarlo en blanco.",
      "intake.rev.under2k": "Menos de $2,000",
      "intake.rev.2k5k": "$2,000 - $5,000",
      "intake.rev.5k15k": "C$183,000 – C$549,000",
      "intake.rev.15k50k": "C$549,000 – C$1.8 millones",
      ...
      "intake.ind.hardware": "Ferretería / materiales de construcción",
      "intake.ind.pharmacy": "Farmacia",
      ...
      "man.title": "Bajo la superficie, el potencial.",
      "man.p1": "Hay un patrón que se repite en cada economía emergente. Las empresas que generan empleo, mueven capital y sostienen comunidades operan con una fracción de la infraestructura que necesitan. No porque no exista — sino porque nadie ha construido el puente entre lo que la tecnología puede hacer y lo que estas empresas realmente necesitan.",
      "man.p2": "En América Latina, ese vacío es particularmente agudo.",
      "man.p3": "La región produce el 8% del PIB mundial. Sus empresas atienden a 660 millones de personas. Y la gran mayoría opera con las mismas herramientas que usaba hace una década: cuadernos, hojas de cálculo, grupos de WhatsApp, y decisiones tomadas por instinto porque los datos que necesitan están atrapados en algún lugar que no pueden alcanzar.",
      "man.p4": "Esto no es un problema de voluntad. Es un problema de acceso.",
      "man.p5": "Las firmas globales de consultoría venden transformación digital a $500 la hora — fuera del alcance del 95% de las empresas de la región. Las agencias locales construyen sitios web y desaparecen. Los proveedores de software venden plataformas genéricas diseñadas para mercados que no se parecen al nuestro. Y mientras tanto, el gap se amplía.",
      "man.break": "Ignea Labs existe para cerrar ese gap.",
      ...
      "man.p7": "Nuestro nombre viene del latín igneus — nacido del fuego. La roca ígnea se forma cuando la presión transforma materia prima en terreno nuevo. Eso es lo que hacemos: encontramos el potencial dormido bajo la superficie de tu operación y lo convertimos en ventaja competitiva permanente.",
      "man.p8": "Trabajamos con un número limitado de empresas a la vez. No por falta de capacidad, sino por convicción. La transformación operativa no se logra con implementaciones masivas ni con soluciones de catálogo. Se logra con proximidad, con honestidad sobre lo que va a funcionar y lo que no, y con el tipo de atención que desaparece cuando intentas atender a todos al mismo tiempo.",
      "man.p9": "Cada empresa que tomamos recibe el peso completo de lo que sabemos. Esto no es una filosofía de marca. Es un compromiso contractual.",
      "man.p10": "El resultado es medible: horas recuperadas, costos reducidos, ingresos capturados que antes se perdían. Cada automatización habilita la siguiente. Cada dato nuevo agudiza la decisión que sigue. La distancia entre tu empresa y tu competencia se amplía — primero en silencio, y después de golpe.",
      "man.p11": "La próxima generación de líderes empresariales en América Latina no se definirá por qué producto lanzaron ni qué mercado conquistaron. Se definirá por una sola decisión: si construyeron la infraestructura para competir en la economía que viene, o si dejaron que la brecha se volviera permanente.",
      "man.closing": "No vendemos inteligencia artificial. Construimos terreno nuevo.",
      ...
      "intake.ind.tech": "Tecnología",
      "intake.ind.consulting": "Consultoría",
      "intake.ind.ecommerce": "E-commerce",
      "intake.ind.insurance": "Seguros",
      "intake.ind.pharma": "Farmacéutica",
      "intake.ind.energy": "Energía",
      "intake.ind.automotive": "Automotriz",
      "intake.ind.media": "Medios y comunicación",
      "intake.ind.government": "Gobierno",

      // ---- DIAGNOSTIC: NEW REVENUE RANGES ----
      "intake.rev.under5k": "Menos de C$183,000",
      "intake.rev.50k150k": "C$1.8 – C$5.5 millones",
      "intake.rev.150k500k": "C$5.5 – C$18.3 millones",
      "intake.rev.500k1m": "C$18.3 – C$36.6 millones",
      "intake.rev.over1m": "Más de C$36.6 millones",

      // ---- OPS: ACCESS GATE ----
      "ops.gate.label": "Código de acceso",
      ...
      "ops.leads.tag": "// Directorio de leads",
      "ops.pipeline.tag": "// Pipeline de ventas",
      "ops.scraper.tag": "// Scraper de empresas",

      // ---- OPS: LEADS TABLE ----
      "ops.leads.col.date": "Fecha",
      "ops.leads.col.company": "Empresa",
      "ops.leads.col.contact": "Contacto",
      "ops.leads.col.industry": "Industria",
      "ops.leads.col.score": "Score",
      "ops.leads.col.stage": "Etapa",
      "ops.leads.col.priority": "Prioridad",
      "ops.leads.col.dealValue": "Valor",
      "ops.leads.col.actions": "Acciones",
      "ops.leads.searchPlaceholder": "Buscar empresa, contacto...",

      // ---- OPS: PIPELINE STATS ----
      "ops.pipe.pipelineValue": "Valor Pipeline",
      "ops.pipe.closedWon": "Cerrados Ganados",
      "ops.pipe.conversion": "Tasa Conversión",

      // ---- OPS: STAGES ----
      "ops.stage.meeting_scheduled": "Reunión",
      "ops.stage.proposal_sent": "Propuesta",
      "ops.stage.closed_won": "Cerrado ✓",
      "ops.stage.closed_lost": "Perdido ✗",
      "ops.stage.on_hold": "Pausado",

      // ---- OPS: PRIORITIES ----
      "ops.priority.warm": "Tibio",
      "ops.priority.cold": "Frío",

      // ---- OPS: CALCULATOR ----
      "ops.calc.industryLabel": "Industria / Giro",
      "ops.calc.industryPlaceholder": "ej. Restaurante, Clínica, Hotel...",
      "ops.calc.teamLabel": "Tamaño del equipo",
      "ops.calc.teamHint": "Número de empleados",
      "ops.calc.hoursLabel": "Horas desperdiciadas / semana",
      "ops.calc.methodsLabel": "Métodos actuales de gestión",
      "ops.calc.method.paper": "Papel / cuadernos",
      "ops.calc.method.excel": "Excel / hojas de cálculo",
      "ops.calc.method.software": "Software especializado",
      "ops.calc.method.whatsapp": "WhatsApp / mensajería",
      "ops.calc.method.memory": "Memoria / verbal",
      "ops.calc.techLabel": "Herramientas tecnológicas actuales",
      "ops.calc.tech.none": "Ninguna",
      "ops.calc.tech.social": "Redes sociales",
      "ops.calc.tech.wa_business": "WhatsApp Business",
      "ops.calc.tech.excel": "Excel / Google Sheets",
      "ops.calc.tech.accounting": "Software contable",
      "ops.calc.tech.crm": "CRM",
      "ops.calc.tech.pos": "POS / Caja registradora",
      "ops.calc.websiteLabel": "Presencia web actual",
      "ops.calc.website.0": "Sin presencia",
      "ops.calc.website.1": "Solo redes sociales",
      "ops.calc.website.2": "Sitio web básico",
      "ops.calc.website.3": "Sitio web + e-commerce",
      "ops.calc.aiLabel": "Adopción de IA actual",
      "ops.calc.ai.0": "No usa IA",
      "ops.calc.ai.1": "Experimenta ocasionalmente",
      "ops.calc.ai.2": "Usa herramientas IA básicas",
      "ops.calc.ai.3": "IA integrada en procesos",
      "ops.calc.revenueLabel": "Ingresos mensuales (USD)",
      "ops.calc.revenue.0": "Menos de $5K",
      "ops.calc.revenue.1": "$5K – $15K",
      "ops.calc.revenue.2": "$15K – $50K",
      "ops.calc.revenue.3": "$50K – $150K",
      "ops.calc.revenue.4": "$150K – $500K",
      "ops.calc.revenue.5": "$500K – $1M",
      "ops.calc.revenue.6": "Más de $1M",
      "ops.calc.captureLabel": "% de ahorro a capturar",
      "ops.calc.leadLabel": "Lead vinculado",
      "ops.calc.leadNone": "— Sin vincular —",

      // ---- OPS: SCRAPER ----
      "ops.scraper.inputsTitle": "Configuración del scrape",
      "ops.scraper.urlLabel": "URL del negocio",
      "ops.scraper.urlPlaceholder": "https://ejemplo.com",
      "ops.scraper.urlHint": "Sitio web, Google Maps, Facebook...",
      "ops.scraper.nameLabel": "Nombre de la empresa",
      "ops.scraper.namePlaceholder": "Nombre del negocio",
      "ops.scraper.locationLabel": "Ubicación",
      "ops.scraper.leadLabel": "Vincular a lead existente",
      "ops.scraper.leadNone": "— Crear nuevo lead —",
      "ops.scraper.emptyMsg": "Ejecuta un scrape para ver los resultados aquí.",
    },
    ...
    en: {
      ...
      "intake.landing.sub": "5 short questions. Zero commitment. Gives us what we need to show up to the call prepared — so you don't waste time repeating the basics.",
      "intake.landing.s1": "5 short questions",
      ...
      "hero.cta.diagnostic": "See what it would cost you",
      "hero.cta.diagnostic.note": "5 questions",
      "ct.ch.diagnostic": "See what it would cost you",
      "intake.phone.hint": "Is that the full number? For example: 8935-9013",
      "intake.field.revenue": "Approximate monthly revenue (optional)",
      "intake.rev.note": "Optional. It helps us propose something the right size. If you'd rather not say, that's fine — you can leave it blank.",
      "intake.rev.under2k": "Under $2,000",
      "intake.rev.2k5k": "$2,000 - $5,000",
      "intake.rev.5k15k": "C$183,000 – C$549,000",
      "intake.rev.15k50k": "C$549,000 – C$1.8 million",
      ...
      "intake.ind.hardware": "Hardware store / building materials",
      "intake.ind.pharmacy": "Pharmacy",
      ...
      "ind.ferre.label": "Ferretería",
      "ind.ferre.pain": "Prices in the owner's head, quotes written by hand, inventory in a notebook.",
      "ind.ferre.solution": "A WhatsApp assistant that checks stock and builds the proforma in the shop's own format.",
      "ind.ferre.out": "Quote and proforma ready in the same conversation",
      ...
      "ind.rest.out": "Orders and bookings recorded without going through the counter",
      ...
      "ind.clinic.out": "Appointment booked and reminder scheduled in the same conversation",
      "ind.hotel.label": "Hotel",
      ...
      "ind.hotel.out": "Availability, booking and payment link in a single thread",
      ...
      "ind.law.out": "Every case with its deadline logged and its alert scheduled",
      ...
      "ind.mfg.out": "Every batch traced from order through delivery",
      ...
      "ind.agro.out": "The traceability file builds itself, audit-ready",
      ...
      "ind.school.out": "Enrolment and parent communication on one channel",
      ...
      "ind.construct.out": "Estimates built from the catalog, with current prices",
      ...
      "pr.c1.desc": "We operate across Latin America. We understand local regulations, supply chains, and how business gets done in each market.",
      ...
      // ---- THESIS ----
      "man.tag": "// Our Thesis",
      "man.title": "Beneath the surface, the potential.",
      "man.p1": "There is a pattern that repeats across every emerging economy. The businesses that create jobs, move capital, and sustain communities operate with a fraction of the infrastructure they need. Not because it doesn't exist — but because no one has built the bridge between what technology can do and what these businesses actually require.",
      "man.p2": "In Latin America, that gap is particularly acute.",
      "man.p3": "The region produces 8% of global GDP. Its businesses serve 660 million people. And the vast majority operate with the same tools they used a decade ago: notebooks, spreadsheets, WhatsApp groups, and decisions made on instinct because the data they need is trapped somewhere they cannot reach.",
      "man.p4": "This is not a problem of willpower. It is a problem of access.",
      "man.p5": "Global consulting firms sell digital transformation at $500 an hour — out of reach for 95% of the region's businesses. Local agencies build websites and vanish. Software vendors sell generic platforms designed for markets that look nothing like ours. And meanwhile, the gap widens.",
      "man.break": "Ignea Labs exists to close that gap.",
      "man.p6": "We are fractional engineers. We don't place consultants on your payroll or sell software licenses. We embed ourselves in your operation, diagnose where time and money are being lost, and build custom AI infrastructure — systems that function like a permanent technical team, without the fixed cost.",
      "man.p7": "Our name comes from the Latin igneus — born of fire. Igneous rock forms when pressure transforms raw material into new ground. That is what we do: we find the dormant potential beneath the surface of your operation and convert it into permanent competitive advantage.",
      "man.p8": "We work with a limited number of companies at a time. Not for lack of capacity, but out of conviction. Operational transformation doesn't come from mass implementations or off-the-shelf solutions. It comes from proximity, from honesty about what will work and what won't, and from the kind of attention that disappears the moment you try to serve everyone at once.",
      "man.p9": "Every company we take on receives the full weight of what we know. This is not a brand philosophy. It is a contractual commitment.",
      "man.p10": "The result is measurable: hours recovered, costs reduced, revenue captured that was previously lost. Every automation enables the next. Every new data point sharpens the decision that follows. The distance between your business and your competition widens — first quietly, then all at once.",
      "man.p11": "The next generation of business leaders in Latin America will not be defined by what product they launched or what market they conquered. They will be defined by a single decision: whether they built the infrastructure to compete in the economy that's coming, or let the gap become permanent.",
      "man.closing": "We don't sell artificial intelligence. We build new ground.",
      ...
      "intake.ind.tech": "Technology",
      "intake.ind.consulting": "Consulting",
      "intake.ind.ecommerce": "E-commerce",
      "intake.ind.insurance": "Insurance",
      "intake.ind.pharma": "Pharmaceutical",
      "intake.ind.energy": "Energy",
      "intake.ind.automotive": "Automotive",
      "intake.ind.media": "Media & Communications",
      "intake.ind.government": "Government",

      // ---- DIAGNOSTIC: NEW REVENUE RANGES ----
      "intake.rev.under5k": "Under C$183,000",
      "intake.rev.50k150k": "C$1.8 – C$5.5 million",
      "intake.rev.150k500k": "C$5.5 – C$18.3 million",
      "intake.rev.500k1m": "C$18.3 – C$36.6 million",
      "intake.rev.over1m": "Over C$36.6 million",

      // ---- OPS: ACCESS GATE ----
      "ops.gate.label": "Access code",
      "ops.gate.placeholder": "········",
      ...
      "ops.leads.tag": "// Leads directory",
      "ops.pipeline.tag": "// Sales pipeline",
      "ops.scraper.tag": "// Business scraper",

      // ---- OPS: LEADS TABLE ----
      "ops.leads.col.date": "Date",
      "ops.leads.col.company": "Company",
      "ops.leads.col.contact": "Contact",
      "ops.leads.col.industry": "Industry",
      "ops.leads.col.score": "Score",
      "ops.leads.col.stage": "Stage",
      "ops.leads.col.priority": "Priority",
      "ops.leads.col.dealValue": "Value",
      "ops.leads.col.actions": "Actions",
      "ops.leads.searchPlaceholder": "Search company, contact...",

      // ---- OPS: PIPELINE STATS ----
      "ops.pipe.pipelineValue": "Pipeline Value",
      "ops.pipe.closedWon": "Closed Won",
      "ops.pipe.conversion": "Conversion Rate",

      // ---- OPS: STAGES ----
      "ops.stage.meeting_scheduled": "Meeting",
      "ops.stage.proposal_sent": "Proposal",
      "ops.stage.closed_won": "Closed ✓",
      "ops.stage.closed_lost": "Lost ✗",
      "ops.stage.on_hold": "On Hold",

      // ---- OPS: PRIORITIES ----
      "ops.priority.warm": "Warm",
      "ops.priority.cold": "Cold",

      // ---- OPS: CALCULATOR ----
      "ops.calc.industryLabel": "Industry",
      "ops.calc.industryPlaceholder": "e.g. Restaurant, Clinic, Hotel...",
      "ops.calc.teamLabel": "Team size",
      "ops.calc.teamHint": "Number of employees",
      "ops.calc.hoursLabel": "Hours wasted / week",
      "ops.calc.methodsLabel": "Current management methods",
      "ops.calc.method.paper": "Paper / notebooks",
      "ops.calc.method.excel": "Excel / spreadsheets",
      "ops.calc.method.software": "Specialized software",
      "ops.calc.method.whatsapp": "WhatsApp / messaging",
      "ops.calc.method.memory": "Memory / verbal",
      "ops.calc.techLabel": "Current tech tools",
      "ops.calc.tech.none": "None",
      "ops.calc.tech.social": "Social media",
      "ops.calc.tech.wa_business": "WhatsApp Business",
      "ops.calc.tech.excel": "Excel / Google Sheets",
      "ops.calc.tech.accounting": "Accounting software",
      "ops.calc.tech.crm": "CRM",
      "ops.calc.tech.pos": "POS / Cash register",
      "ops.calc.websiteLabel": "Current web presence",
      "ops.calc.website.0": "No presence",
      "ops.calc.website.1": "Social media only",
      "ops.calc.website.2": "Basic website",
      "ops.calc.website.3": "Website + e-commerce",
      "ops.calc.aiLabel": "Current AI adoption",
      "ops.calc.ai.0": "Not using AI",
      "ops.calc.ai.1": "Experimenting occasionally",
      "ops.calc.ai.2": "Using basic AI tools",
      "ops.calc.ai.3": "AI integrated into processes",
      "ops.calc.revenueLabel": "Monthly revenue (USD)",
      "ops.calc.revenue.0": "Under $5K",
      "ops.calc.revenue.1": "$5K – $15K",
      "ops.calc.revenue.2": "$15K – $50K",
      "ops.calc.revenue.3": "$50K – $150K",
      "ops.calc.revenue.4": "$150K – $500K",
      "ops.calc.revenue.5": "$500K – $1M",
      "ops.calc.revenue.6": "Over $1M",
      "ops.calc.captureLabel": "% of savings to capture",
      "ops.calc.leadLabel": "Linked lead",
      "ops.calc.leadNone": "— Not linked —",

      // ---- OPS: SCRAPER ----
      "ops.scraper.inputsTitle": "Scrape configuration",
      "ops.scraper.urlLabel": "Business URL",
      "ops.scraper.urlPlaceholder": "https://example.com",
      "ops.scraper.urlHint": "Website, Google Maps, Facebook...",
      "ops.scraper.nameLabel": "Company name",
      "ops.scraper.namePlaceholder": "Business name",
      "ops.scraper.locationLabel": "Location",
      "ops.scraper.leadLabel": "Link to existing lead",
      "ops.scraper.leadNone": "— Create new lead —",
      "ops.scraper.emptyMsg": "Run a scrape to see results here.",
    }
  };
